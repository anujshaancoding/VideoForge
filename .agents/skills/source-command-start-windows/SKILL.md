---
name: "source-command-start-windows"
...
# source-command-start-windows

Use this skill when the user asks to run the migrated source command `start-windows`.
...
1. Read the Windows guide as the source of truth:
   ...
   - skim root [`AGENTS.md`](../../AGENTS.md) for product facts.
